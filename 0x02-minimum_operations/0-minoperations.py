...
def minOperations(n):
    """
    Calculate the minimum number of operations needed to obtain exactly n 'H' characters
    in a text file starting with a single 'H'. The operations are Copy All and Paste.
